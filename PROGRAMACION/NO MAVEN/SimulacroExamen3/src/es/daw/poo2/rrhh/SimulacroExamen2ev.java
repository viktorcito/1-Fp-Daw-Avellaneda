...
public class SimulacroExamen2ev {
    ...
    public static void main(String[] args) {
        ...
        try {
            Empleado nuevoEmpleadCorrect = new EmpleadoFijo(3000,"Mari", "A", "B", "88888888K", "dasdfasdf", 0, "email", Categorias.JUNIOR);
        ...
        for (Empleado e : empleados) {
            ...
            System.out.println("Paga extra"+e.calcularFactorPagaExtrar());
        }
        ...
        while (it.hasNext()) {
            ...
            if (e instanceof EmpleadoTemporal){
                ...
                if (ffc.equals(LocalDate.of(0, Month.MARCH, 0)))
                    it.remove();
            }
        }
