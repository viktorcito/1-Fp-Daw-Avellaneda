...
public class Utilidades {
    ...
    public static void mostrarMenu() {
        ...
        System.out.println("\t12. Mostrar informacion transacciones");
        System.out.println("\t----------------------------------------------");
    ...
    //FASE 4 SERIA GESTIONAR LAS TRANSACCIONES DE ENTRADA Y SALIDA CON LO QUE HAY DENTRO DE CADA PARKING
    //1.Tendria que cambiar la estructura de datos para almacenar los vehiculos dentro del parking,2. una nueva clase
    //para tener informacion de cada uno que entra y sale,3. modificar entrada y salida de vehiculos 4. mostrar esos vehiculos 
