...
/**
 * PATRÓN SINGLETON
 * Este patrón de diseño se encarga de que una clase determinada
 * únicamente pueda tener un único objeto.
 * Genera una única instancia en la ejecución del programa
 * y proporciona un acceso global a la misma.
 */
